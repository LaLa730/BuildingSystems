...
function Login() {
    ...
    return(
        ...
        <div className="mb-3">
            <br>
            {isLogin ? <h5>First time user? Please <button className="btn btn-primary" onClick = {() => setLogin(false)}Register></button>here</h5> 
            : <h5>Already have an account? <button className="btn btn-primary" onClick = {() => setLogin(true)}Login></button>here</h5>}
            </br>
        </div>
